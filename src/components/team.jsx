        ...
        <div className='flex flex-col justify-center space-y-6'>
            <div className='space-y-2'>
             ...
             <div className='flex items-center gap-3 text-blue-600'>
                <span className="text-lg text-white leading-relaxed">21 years</span>
                <span>|</span>
                <span className="text-lg text-white leading-relaxed"> 6 ft 00In</span>
                <span>|</span>
                <span className="text-lg text-white leading-relaxed"> 73kg</span>
