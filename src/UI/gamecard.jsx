    ...
    return(
      ...
      <div className="lg:hidden">
        ...
        <div className="flex justify-between p-4">
          <div>
            <p className="text-sm uppercase tracking-wide font-bold font-semibold">{game.day}</p>
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900">{game.date}</h2>
            {game.type === "UPCOMING" ? (
                <>
                <p className="text-lg font-semibold">{game.time}</p>
                </>
                ) : (
        ...
        <div className="grid grid-cols-[70px_1.5fr_1fr_200px_200px]">
          ...
          <div
          className={`flex items-center justify-center ${currentStatus.bg} border-r ${currentStatus.border}`}
          >
            <span
            className={`rotate-[-90deg] text-xs font-bold tracking-widest uppercase ${currentStatus.text}`}
            >
                {game.status}
            </span>
            </div>
